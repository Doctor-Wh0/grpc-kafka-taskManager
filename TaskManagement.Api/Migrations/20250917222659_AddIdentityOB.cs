...
{
    /// <inheritdoc />
    public partial class AddIdentityOB : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                name: "TaskNoteRelatedTasks",
                columns: table => new
                {
                    TaskNoteId = table.Column<Guid>(type: "uuid", nullable: false),
                    RelatedTaskId = table.Column<Guid>(type: "uuid", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_TaskNoteRelatedTasks", x => new { x.TaskNoteId, x.RelatedTaskId });
                    table.ForeignKey(
                        name: "FK_TaskNoteRelatedTasks_Tasks_RelatedTaskId",
                        column: x => x.RelatedTaskId,
                        principalTable: "Tasks",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_TaskNoteRelatedTasks_Tasks_TaskNoteId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_TaskNoteRelatedTasks_RelatedTaskId",
                table: "TaskNoteRelatedTasks",
